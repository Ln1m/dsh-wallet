...
.dsw-bal-row{display:flex;align-items:baseline;justify-content:space-between;gap:8px;}
.dsw-bal-cur{color:var(--dsw-alias-label-secondary);font-size:11px;}
.dsw-band{display:inline-block;padding:0 6px;border-radius:999px;font-size:10px;line-height:15px;margin-left:5px;font-weight:600;vertical-align:middle;text-align:center;}
